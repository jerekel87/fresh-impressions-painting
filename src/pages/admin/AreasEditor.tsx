    ...
    <div className="max-w-4xl">
      ...
      {activeTab === 'counties' && (
        <div className="space-y-8">
          ...
          <button onClick={() => saveContent('counties', counties)} disabled={saving} className="inline-flex items-center gap-2 px-6 py-3 bg-brand-yellow text-navy-900 font-bold text-[13px] tracking-[0.08em] uppercase hover:bg-brand-gold transition-colors disabled:opacity-50 rounded-md">
            <Save className="w-4 h-4" />
            Save Counties
          </button>
        </div>
