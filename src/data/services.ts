...
// Placeholder project photos. The originals were lost (0-byte files) and replaced
// with stock images so the galleries render. Replace these via the admin image uploader.
const px = (id: number) =>
  `https://images.pexels.com/photos/${id}/pexels-photo-${id}.jpeg?auto=compress&cs=tinysrgb&w=1200&h=800&fit=crop`;

const photoJul28a = px(1571459);
const photoJul28b = px(1571460);
const photoJun28 = px(2062426);
const photoAug26 = px(2121121);
const photoDec28 = px(323780);
const photoJul15 = px(280229);
const photoNov17 = px(1396122);
const photoNov28 = px(1669799);
const photoDec05 = px(2079234);
const photoJun16 = px(1732414);
const photoMar19 = px(2219024);
const photoMar23 = px(209296);
const photoOct03 = px(1643383);
const photoOct07 = px(2098913);
const photoSep14 = px(2062426);
const photoJul18 = px(1648776);
const photoMar13 = px(2251247);
const photoNov30 = px(2098913);
const photoFeb23 = px(2062426);
const photoJun28_2024 = px(1643383);
const photoAug19 = px(1571459);
const photoApr08 = px(323780);
const photoAug04 = px(280229);
const photoOct26_38 = px(1643383);
const photoJul16_09 = px(1571459);
const photoJul16_12 = px(1571460);
const photoJul16_12b = px(2062426);
const photoOct26_16 = px(2121121);
const photoDec21 = px(1648776);
const photoOct26_08 = px(2251247);
const photoSep28 = px(2724745);
const photoMar18 = px(1642125);
const photoMay10 = px(259950);
const photoMar20 = px(2724749);
const photoMar09 = px(1438832);
const photoAug24 = px(1732414);
const photoMar27 = px(2062426);
const photoMar27_1 = px(1648776);
const photoMar27_2 = px(1571460);
const photoNov20 = px(2098913);
const photoAug12 = px(1571460);
const photoAug29 = px(1571459);
const photoMay31 = px(1643383);
